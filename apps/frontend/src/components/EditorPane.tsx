    ...
    <div className="flex-1 flex flex-col p-6">
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          type="button"
          onClick={onCompile}
          className={`${compiled ? "bg-green-500" : "bg-accentStrong"} relative text-white px-5 py-2 rounded-full shadow-soft hover:opacity-95 flex gap-2 items-center justify-center`}
        >
          {charging && (
        ...
        <span className={charging ? "opacity-0" : "opacity-100"}>
          Compilar
        </span>
        </button>
      </div>
